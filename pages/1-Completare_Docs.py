        ...
        if uploaded_doc3 is not None:
            ...
            if nr_CAEN != 'N/A' and date_financiare:
               ...
               # cheltuieli_text = '\n'.join([rezultat for _, _, rezultat in rezultate_corelate1]) - Eliminat datorita schimbarii variabilei cheltuieli_buget
                ...
                procentCAtemp = extrage_valoare_din_df(df_financiar, 32, "procent crestere CA an 1 durabilitate vs an referinta", 18, 'Valoarea pentru: Procent Crestere CA an 1 durabilitate vs an referinta Nu a putut fi gasita in P.FINANCIAR')
